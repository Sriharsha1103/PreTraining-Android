import java.io.*;
public class  OOP_PersonAndSubclasses {
	public static void main(String[] a) {
		
		Person obj1=new Person("Harsha","VVIT,Nambur");
		System.out.println(obj1.toString());

		Student obj2=new Student("Harsha","VVIT,NAMBUR","B.Tech",3,80000.00);
		System.out.println(obj2.toString());

		Staff obj3=new Staff("HARSHA","Vvit, nambur","VIVA School",37162.35);
